            ...
            <div className="col-xl-4 col-6">
                <div className="product">
                    <div className="product-image">
                        {this.props.remain===0?<div className="ribbon ribbon-danger">Sold out</div>:''}{this.state.images.length>0?<img  src={this.state.images[1].url} width="261px" height="391px" alt="product" />:<img  src={Image} width="261px" height="391px" alt="product" />}
